...
use App\Filament\Resources\Timesheet\TimesheetResource\Pages\ProjectListing;
use App\Filament\Resources\Timesheet\TimesheetResource\RelationManagers;
use App\Filament\Resources\TimesheetResource\Pages\TaskStatus;
...
class TimesheetResource extends Resource
{
        ...
        // ->modifyQueryUsing(fn (Builder $query) => $query->orWhere('user_id',auth()->id())->orWhere('created_by',auth()->id()))
            ->columns([
                ...
                ->default(function($record){
                    ...
                    elseif($total_count== $inpro_count){
                        return '40%';
                    }elseif($total_count== $assine_count){
                        return '10%';
                    }else{
                        if($total_count== $total_RD){
                            return '95%';
                        }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'edit'=>TaskStatus::route('/{record}/edit'),
        ];
    }
}
